...
struct ContentView: View {
    ...
    private func loadSystemPrompt() -> String {
        return """
            ...
            Do NOT try to find a chat first.
            Use bluebubbles_request → POST /api/v1/chat/new with:
            addresses: [normalizedAddress]
            message: the user’s message text
            This single call will find the existing chat OR create a new one, and send the message.
            ...
            PROCEED IMMEDIATELY. Do NOT ask "Did you mean Mom Smith?". Just use that contact.
            ...
            If a single match is found, USE IT IMMEDIATELY. Do NOT ask for confirmation.
            ...
            Use bluebubbles_request to POST /api/v1/chat/new with address and message.
